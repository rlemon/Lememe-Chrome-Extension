(function() {
    var canvas = document.getElementById('canvas'),
        ...
        input_top = document.getElementById('input-top'),
        input_bottom = document.getElementById('input-bottom'),
    ...
    function register_event_handlers() {
        [text_size, outline_size, padding_x, padding_y].forEach(function(input) {
            input.addEventListener('change', range_input_onchange_handler, true);
            range_input_onchange_handler.call(input);
        });
